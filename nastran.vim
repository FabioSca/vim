...
" fabio.scannavino@mscsoftware.com
" 
"----------------------------------------------------------------------
...
function! NastranFold() 
   if has("folding")
       " Fold all lines that do not begin with *
       setlocal foldexpr=getline(v:lnum)[0]==\"C\"\|\|getline(v:lnum)[0]==\"G\"\|\|getline(v:lnum)[0]==\"R\"\|\|getline(v:lnum)[0]==\"S\"\|\|getline(v:lnum)[0]=~'^\\s'\|\|getline(v:lnum)[0]=~'^\*'\|\|getline(v:lnum)[0]==\"+\"
...
"if has("folding")
"    " Fold all lines that do not begin with *
"    set foldexpr=NastranFoldExpr(v:lnum) 
"    :setlocal foldmethod=expr
"endif
