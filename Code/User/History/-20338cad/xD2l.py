...
def add_res(file2,g1):
    ...
    with h5py.File(file2, 'a') as hdf:
        ...
        if check_res == False:
            ...
            np.append(attributi, b'PIPPO')
            
            elem_post_summary.attrs["user_post_label"] = attributi
        ...
        for nome_dataset in g1 :
            ...
            dataset = g1[nome_dataset]
            dset = hdf.create_dataset('/Marc/Results/Element/Scalar/PIPPO/' + nome_dataset, dtype=dtype_float, data=dataset)
