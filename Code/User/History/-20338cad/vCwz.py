...
def prende_massimo(dset3, dataset1, dataset2 ):
...
def add_res(file2,g1):
    ...
    with h5py.File(file2, 'a') as hdf:
        ...
        for nome_dataset in g1 :
            ...
            dset3 = hdf.create_dataset('/Marc/Results/Element/Scalar/PIPPO/' + nome_dataset, dtype=dtype_float, data=dataset1) # copia 1

            dset3 = prende_massimo(dset3, dataset1, dataset2 )
